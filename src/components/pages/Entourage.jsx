  ...
  return (
    <>
            ...
            <div className="text-center mb-12">
              <h2 ref={headerRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8">
                ...
                <div className="flex flex-col items-center justify-center">
                  {/* Groom's Name */}
                  <div>
                    <p className="font-tebranos text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase leading-tight" style={{ color: '#3a3148' }}>
                  ...
                  <p className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl uppercase leading-tight my-1" style={{ color: '#3a3148' }}>
                    AND
                  </p>
                  {/* Bride's Name */}
                  <div>
                ...
                {/* NUPTIALS */}
                <div className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl block leading-none uppercase mt-8" style={{ lineHeight: '0.8', color: '#3a3148' }}>
                  NUPTIALS
                </div>
              </h2>
            </div>
            ...
            <div className="space-y-10 entourage-names-single-line">
              ...
              <div ref={parentsRef} className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-3 text-right uppercase" style={{ color: '#3a3148' }}>Parents of the Groom</p>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-3 text-left uppercase" style={{ color: '#3a3148' }}>Parents of the Bride</p>
              ...
              {principalSponsors && (
                <div ref={principalSponsorsRef}>
                  <h3 className="text-lg sm:text-xl md:text-2xl imperial-script-regular font-bold mb-6 text-center" style={{ color: '#3a3148' }}>Principal sponsors</h3>
                  <div className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#3a3148' }}>Ninong</p>
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-left uppercase" style={{ color: '#3a3148' }}>Ninang</p>
                      <div className="space-y-1.5">
              ...
              <div className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                {bestman && (
                  <div ref={bestmanRef} className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#3a3148' }}>Best Man</p>
                ...
                {maidOfHonor && (
                  <div ref={maidOfHonorRef} className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-left uppercase" style={{ color: '#3a3148' }}>Maid of Honor</p>
              ...
              <div>
                <h3 className="text-lg sm:text-xl md:text-2xl imperial-script-regular font-bold mb-8 text-center" style={{ color: '#3a3148' }}>Secondary sponsors</h3>

                {candleSponsors && (
                  <div ref={candleSponsorsRef} className="mb-8 flex flex-col gap-1 justify-center items-center">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Candle</p>
                ...
                {veilSponsors && (
                  <div ref={veilSponsorsRef} className="mb-8 flex flex-col gap-1 justify-center items-center">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Veil</p>
                ...
                {cordSponsors && (
                  <div ref={cordSponsorsRef} className="mb-8 flex flex-col gap-1 justify-center items-center">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Cord</p>
                ...
                {secondarySponsors && (
                  <div ref={secondarySponsorsRef} className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#3a3148' }}>Groomsmen</p>
                      <div className="space-y-1.5">
              ...
              {ringBearer && (
                <div ref={ringBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Ring Bearer</p>
              ...
              {bibleBearer && (
                <div ref={bibleBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Bible Bearer</p>
              ...
              {coinBearer && (
                <div ref={coinBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Coin Bearer</p>
              ...
              {flowerBoys && (
                <div ref={flowerBoysRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Flower Boy</p>
              ...
              {flowerGirls && (
                <div ref={flowerGirlsRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#3a3148' }}>Flower Girls</p>
      ...
      <button
        ...
        className="fixed bottom-12 right-6 z-[100] w-14 h-14 bg-gold text-[#fff4e6] rounded-full shadow-lg border border-forest/10 hover:bg-gold-dark hover:text-[#fff4e6] hover:scale-110 transition-all duration-300 flex items-center justify-center group"
